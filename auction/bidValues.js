...
var sCoachesBidValues = function () {
    var sCoachesBidValuesInit =  Array.from({length: 6}, () => Math.floor(Math.random() * (50 - 20) + 20)); // to be called 6 times
...
var sMedicsBidValues = function () {
    var sMedicsBidValuesInit =  Array.from({length: 6}, () => Math.floor(Math.random() * (10 - 5) + 5)); // to be called 6 times
...
var sTrainsBidValues = function () {
    var sTrainsBidValuesInit =  Array.from({length: 12}, () => Math.floor(Math.random() * (5 - 1) + 1)); // to be called 12 times
